...
$composedContent = XXX_ServerConfiguration::composeConfigurationFileWithIncludes(XXX_ServerConfiguration::$paths['applicationSources'] . '/Comcordis_Apache_HTTPServer_Configuration/operations/linux/2.4/servers/default/initialize.conf');
